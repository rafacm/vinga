...
- Still open, each with its owner: the LLM-observability exporter over
  the same tap and vocabulary (#67), the read surface over the
  aggregates (#440, whose substrate #439 landed), the audit
