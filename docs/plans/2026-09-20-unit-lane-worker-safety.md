...
- [x] **[M1: the resolved worker count is bounded](2026-09-20-unit-lane-worker-safety-implementation.md#m1-the-resolved-worker-count-is-bounded)** (PR [#538](https://github.com/rafacm/vinga/pull/538)). `--maxprocesses=8`
