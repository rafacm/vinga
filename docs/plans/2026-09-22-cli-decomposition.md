...
- [x] **[M4: refusal reasons](2026-09-22-cli-decomposition-implementation.md#m4-refusal-reasons)** (PR #548). `RefusalReason` and `Problem.reason`
...
- [x] **[M1: the package](2026-09-22-cli-decomposition-implementation.md#m1-the-package)** (PR #549). `config/cli/` with the fifteen modules,
...
- [x] **[M2: the measurement recorded](2026-09-22-cli-decomposition-implementation.md#m2-the-measurement-recorded)**
  ...
  tier.
- [x] **[M3: the dump, the dispatch and the repricing](2026-09-22-cli-decomposition-implementation.md#m3-the-dump-the-dispatch-and-the-repricing)** (PR #551). `Output` and
