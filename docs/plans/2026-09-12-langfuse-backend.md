...
- [x] **[M3: the uploader and the vocabulary](2026-09-12-langfuse-backend-implementation.md#m3-the-uploader-and-the-vocabulary)** (PR #481). `capture_upload.py` with the staging,
