...
Regenerating the manifest is `uv run python -m tests.census.test_command_spellings`
...
MANIFEST_HEADER = (
    ...
    "# tests/census/test_command_spellings.py; do not edit by hand.\n"
    "# Regenerate from vinga-server/ with\n"
    "# `uv run python -m tests.census.test_command_spellings`.\n"
    "#\n"
...
_HISTORICAL_PATHS = (
    ...
    "vinga-server/tests/census/test_command_spellings.py",
